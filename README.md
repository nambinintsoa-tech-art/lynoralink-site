...
└── assets/
    ...
    └── public/
        ├── README.md
        └── LynoraLink.v1.1.apk # APK Android
```
...
```text
public/LynoraLink.v1.1.apk
```

Pour rendre le téléchargement disponible :

1. Envoyez le fichier `public/LynoraLink.v1.1.apk` avec le reste du dossier.
...
Vérifiez que `public/LynoraLink.v1.1.apk` existe réellement avant l’envoi. Un lien HTML ne peut pas créer l’APK.
